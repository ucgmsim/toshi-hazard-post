...
@mock.patch.multiple('toshi_hazard_post.hazard_aggregation.aggregation_task', io=mock.DEFAULT, ToshiFile=mock.DEFAULT, requests=mock.DEFAULT)
class TestSourceBranches(unittest.TestCase):
    ...
    def test_save_and_fetch(self, mock_zipfile, mock_save_sources, io, ToshiFile, requests):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            source_branches_fetched = toshi_hazard_post.hazard_aggregation.aggregation_task.fetch_source_branches('foobar')
