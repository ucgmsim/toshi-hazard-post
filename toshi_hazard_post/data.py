    ...
    def generate_models():
        ...
        for i in range(len(branches_as_hash_composites)):
            ...
            yield hazard_aggregate_curve.IndividualHazardRateRealizations(
                ...
                component_id_0_source_id = branches_as_hash_composites[i][0][0:12],
                component_id_0_gmm_id = branches_as_hash_composites[i][0][12:24],
                component_id_1_source_id = branches_as_hash_composites[i][1][0:12],
                component_id_1_gmm_id = branches_as_hash_composites[i][1][12:24],
                component_id_2_source_id = branches_as_hash_composites[i][2][0:12],
                component_id_2_gmm_id = branches_as_hash_composites[i][2][12:24],
                component_id_3_source_id = branches_as_hash_composites[i][3][0:12],
                component_id_3_gmm_id = branches_as_hash_composites[i][3][12:24],
