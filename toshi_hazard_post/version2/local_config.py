...
Parameters:
    ...
    THP_SCRIPT_WORK_PATH: path for saving any local files
...
def get_config() -> Config:
    ...
    WORK_PATH = os.getenv('THP_SCRIPT_WORK_PATH', config_from_file.script_work_path)
    THS_DIR = os.getenv('THP_THS_LOCAL_DIR', config_from_file.ths_local_dir)
    ...
    THS_S3_REGION = os.getenv('THP_THS_AWS_REGION', config_from_file.ths_aws_region)
